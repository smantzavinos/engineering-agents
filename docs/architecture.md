...
3. **Change the repo safely**: after a reviewed approach, follow the sequential pipeline in
   `docs/process.md` (opportunistic parallel dispatch at the orchestrator's discretion; see
   ADR 0006). For Pi-module changes, run
