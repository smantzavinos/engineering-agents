...
subagent({
  agent: "worker",
  task: "Verify [specific claim from the discussion] against [specific files/modules]. Write findings to [path/findings/current_state.md]. Keep it short and evidence-based.",
  skill: "research"
})
