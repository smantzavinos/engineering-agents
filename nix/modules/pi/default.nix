...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    ) [ "discovery" "design" "discover-and-design" "discover-and-design-simple" "direct-plan" "dynamic-execute-plan" "dynamic-create-plan" "dynamic-review-plan" "dynamic-review-code" "research" "review-approach" "review-epic" "assess-repo" "create-skills" "configure-pi" "pull-request" ]
    );
