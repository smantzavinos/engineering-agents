...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    ) [ "discovery" "design" "execute-plan" "write-plan" "review-tasks" "review-diff" "research" "review-approach" "review-epic" "assess-repo" "create-skills" "configure-pi" "create-new-repo-docs" ]
    );
