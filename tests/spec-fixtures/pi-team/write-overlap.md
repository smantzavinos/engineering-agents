...
|---|---|---|---|---|---|---|---|---|---|---|
| T10 | — | cheap | 1 | — | G1 | Add tenth support file | sandbox/shared/ | C1 | D1 | K1 |
| T3 | T2 | std | 1 | — | G1 | Implement branch alpha | sandbox/t3.txt | C1 | D1 | K1 |
| T1 | — | complex | 1 | api-contract | G1 | Establish the root behavior | sandbox/t1.txt | C1 | D1 | K1 |
| T9 | — | visual | 1 | — | G1 | Add ninth support file | sandbox/shared/file.txt | C1 | D1 | K1 |
