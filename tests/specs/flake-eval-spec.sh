...
if [[ -n "$PI_OUT" && -d "$PI_OUT" ]]; then
  ...
  for skill in discovery design discover-and-design discover-and-design-simple dynamic-execute-plan dynamic-create-plan dynamic-review-plan dynamic-review-code \
